...
As a seasoned full-stack web developer with over 20 years of experience, I'll suggest memory configurations for effectively using Claude Code.

## User Memory (`~/.claude/CLAUDE.md`)

_Personal environment settings commonly applied to all projects_
...
- Use VS Code editor
- Git commit message convention (feat:, fix:, docs:, etc.)
- Shortcut and snippet preferences
- Testing tool preferences (Jest, Vitest, Cypress, etc.)
